...
const { save, createProperty } = AccommodationService;
...
export default class AccommodationController {
    ...
    static async listProperty(req, res) {
        const property = req.body;
        const savedProperty = await createProperty(property);
        return successResponse(res, created, accommodationCreated, undefined, savedProperty);
    }
}